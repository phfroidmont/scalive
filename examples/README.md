...
| `GET /lifecycle/notifications`  | [`NotificationsLiveView.scala`](src/scalive/examples/lifecycle/NotificationsLiveView.scala)                                                                                                                                                                                      | Declarative connection visibility, keyed flash, model-derived document titles, and a side-effect-only after-render hook   |
