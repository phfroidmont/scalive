...
The core component, nested LiveView, flash, async task, async assign, root hook, component hook, and route-level typed mount-aspect runtimes are covered, so the highest-leverage follow-up work is now broader lifecycle error-shape parity and live-session grouping ergonomics.
