...
`,
  ...
  var ALL_CHANGED = /* @__PURE__ */ Symbol("all changed");
  ...
  var View = class _View {
    ...
    connectParams(liveReferer) {
      ...
      params2["_live_referer"] = liveReferer ?? void 0;
      this.joinAttempts++;
      return params2;
    }
    isConnected() {
  ...
  var params = csrfToken ? { _csrf_token: csrfToken } : {};
  var liveSocket = new LiveSocket("/live", Socket, { params });
  liveSocket.connect();
