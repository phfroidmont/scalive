...
| Lifecycle hooks, LiveComponents | `Phoenix.LiveView.attach_hook/4` component limitations | Native parity covered | Stateful components support event, async, and after-render hooks, including detach; params/info stages fail with Scalive-native unsupported-component errors. | Hook callbacks and results use Scalive's typed component API. | Medium |
